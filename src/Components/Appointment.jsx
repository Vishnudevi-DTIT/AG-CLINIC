...
function Appointment() {
  return (
    <section className="py-5 bg-white appointment-section">
      <Container>
        <Row className="g-4 align-items-start">
          {/* LEFT SIDE - Appointment Form */}
          <Col lg={6} md={12}>
            <div className="appointment-box position-relative p-4 bg-white shadow-sm rounded-4">
              <h3 className="fw-bold appointment-title">Book An Appointment</h3>
              ...
              {/* Vertical Tab */}
              <div className="consultation-tab-vertical text-white fw-medium">
                Consultation Free
              </div>
            </div>
          </Col>
          ...
          <Col lg={6} md={12}>
            <div className="p-4 bg-white rounded-4 shadow-sm">
              <h4 className="fw-bold mb-3 text-primary-subtle appointment-subtitle">
                Stay Connected for Complete <br /> Health & Wellness
              </h4>
              <p className="mb-4 text-secondary">
                Stay connected with AG Clinic for personalized, expert care
                across general health, diabetes, skin, hair, and cosmetic needs.
              </p>
                ...
                <Col sm={6}>
                  <Card className="border-0 shadow-sm info-card">
                    <Card.Body>
                      ...
                      <p className="mb-0 small text-secondary">
                        Plot No. 44/45, First Street, Opp. Meenakshi Hospital,
                        New Bus Stand, Thanjavur – 613005.
                      </p>
                    </Card.Body>
                  </Card>
                </Col>

      ...
      <Container>
        <Row className="align-items-center gy-5">
          ...
          <Col lg={6} className="text-center text-lg-start">
            <h3 className="fw-bold Faq-heading mb-3">FAQ</h3>
            <h2
              className="fw-bold mb-3"
              style={{
                fontFamily: "Poppins",
            ...
            <Accordion defaultActiveKey="0">
              ...
              <Accordion.Item
                ...
                className="mb-3 border rounded shadow-sm"
              >
                <Accordion.Header>What hair treatments do you offer?</Accordion.Header>
                <Accordion.Body>
                  We provide solutions for hair fall, dandruff, and scalp care —
                  ensuring healthier, stronger hair.
                </Accordion.Body>
              ...
              <Accordion.Item
                ...
                className="mb-3 border rounded shadow-sm"
              >
                <Accordion.Header>Is walk-in consultation available?</Accordion.Header>
                <Accordion.Body>
                  Yes! We welcome both walk-ins and scheduled appointments.
                </Accordion.Body>
              </Accordion.Item>
              ...
              <Accordion.Item
                ...
                className="mb-3 border rounded shadow-sm"
              >
                <Accordion.Header>Where is AG Clinic located?</Accordion.Header>
                <Accordion.Body>
                  We’re located conveniently in the city center, easy to reach
                  for all patients.
                </Accordion.Body>
          ...
          <Col lg={6} className="text-center position-relative">
            <div className="faq-image-wrapper mx-auto">
              <Image
                src={Doctor2}
                alt="Doctor Consultation"
                fluid
                rounded
                className="shadow doctor-img"
              />
              ...
              <Image
                ...
                fluid
                rounded
                className="shadow position-absolute person-img"
              />
            </div>
          </Col>
        </Row>
